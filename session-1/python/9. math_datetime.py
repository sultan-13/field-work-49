...
def comp_interest(principal, rate, time, comp_per_year):
...
future_amount = comp_interest(principal, interest_rate, year, comp_per_year)
print("Future amount (with compound interest):", future_amount)
