...
std_dict.update({"Grades": 3.7, "Roll": 'C193004'})
print(std_dict)

print(std_dict["Name"], " , ", std_dict['Roll'])

std_dict.pop('Roll')
print(std_dict)

copied_dict = std_dict.copy()
...
avg_grade = {}
for name, grades in mark_sheet.items():
    avg_marks = sum(grades) / len(grades)
    avg_grade[name] = avg_marks

print("Average Grades:")
for name, avg_grade in avg_grade.items():
    print(f"{name}: {avg_grade:.3f}")
