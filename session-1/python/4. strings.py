...
ext_words = simple_string.split(',')  # Splits the string into a list of ext_words
# print("Array of ext_words:", ext_words)

# Joining strings
joined_string = ' '.join(ext_words)  # Joins the list back into a single string
...
bio_data = 'I am harry potter. I am 11 years old. I am from England.'

ext_words = bio_data.split()

print(ext_words)

name = ext_words[2] + " " + ext_words[3] 
age = ext_words[6]  
country = ext_words[-1]  
...
formatted_string = "I am {name}. I am {age} years old and my height is {height} feet."

print(formatted_string.format(**my_info))
...
#Assignment (added in): write a Regex to match BD phone number formats

BD_phone_regex = r"\b(?:\d{3}[-.]?\d{4}[-.]?\d{6}|\d{11})\b"
text = "Call me at 880-1871-582887 tomorrow, or at 01680345457 for office line."
BD_format_phones = re.findall(BD_phone_regex, text)
print("Phone numbers found:", BD_format_phones)
