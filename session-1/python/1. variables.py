...
age = 23 # 23 could be the age of John. (previously addressed as _bad_name)


#newly created variables with good naming practice.
fiction_name = "Game of Thrones"
num_of_season = 8
sig_motto = "Winter is coming."
runtime = 77.55 # 77 hour 55 minutes
...
building = 11 # building number 11
print(building)
