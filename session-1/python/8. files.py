...
csv_file_path = 'D:\Downloads\iiuc-industrial-training-49-main\iiuc-industrial-training-49-main\session-1\python\product.csv'  # Replace with your actual CSV file path
json_file_path = 'new json file.json' 
